...
impl WawkEngine {
    ...
    pub fn exec(
        ...
        let mut reader = traits::BufferedReader::new(input);
        let mut writer = traits::BufferedWriter::new();
    ...
    pub fn invoke_function(
        ...
        let program = parse(script)?;
        let mut reader = traits::BufferedReader::new("");
        let mut writer = traits::BufferedWriter::new();
    ...
    ///
    /// let mut reader = BufferedReader::new("5\n10\n");
    /// let mut writer = BufferedWriter::new();
    /// let env = SandboxEnvironment::default();
    /// let mut cmd = BlockedCommandExecutor;
    ///
...
pub fn exec_awk(script: &str, input: &str) -> AwkResult<String> {
    let engine = WawkEngine::new();
    let env = traits::SandboxEnvironment::default();
    let mut cmd = traits::BlockedCommandExecutor;
