...
pub mod wawk {
    pub mod plugins {
        ...
        pub mod external_functions {
            ...
            pub fn call(name: &str, args: &[_rt::String]) -> Option<_rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
                    ...
                    let ptr3 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "wawk:plugins/external-functions")]
                    unsafe extern "C" {
                        #[link_name = "call"]
                        fn wit_import4(
                            _: *mut u8,
        ...
        pub mod format_handler {
            ...
            pub fn detect(input: &str) -> _rt::String {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
                    ...
                    let ptr1 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "wawk:plugins/format-handler")]
                    unsafe extern "C" {
                        #[link_name = "detect"]
                        fn wit_import2(_: *mut u8, _: usize, _: *mut u8);
                    }
            ...
            pub fn parse(input: &str) -> _rt::String {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
            ...
            pub fn serialize(tree_json: &str) -> _rt::String {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_cli_runner_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_cli_runner_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:wawk:wasi-cli@0.1.0:cli-runner:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 5483] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xea)\x01A\x02\x01A%\x01\
...
get-stderr\x01\x03\x03\0\x15wasi:cli/stderr@0.2.6\x05\x0b\x01B\x0f\x02\x03\x02\x01\
...
s/monotonic-clock@0.2.6\x05\x0c\x01B\x05\x01r\x02\x07secondsw\x0bnanosecondsy\x04\
\0\x08datetime\x03\0\0\x01@\0\0\x01\x04\0\x03now\x01\x02\x04\0\x0aresolution\x01\
\x02\x03\0\x1cwasi:clocks/wall-clock@0.2.6\x05\x0d\x02\x03\0\x04\x05error\x02\x03\
\0\x09\x08datetime\x01Br\x02\x03\x02\x01\x07\x04\0\x0cinput-stream\x03\0\0\x02\x03\
\x02\x01\x09\x04\0\x0doutput-stream\x03\0\x02\x02\x03\x02\x01\x0e\x04\0\x05error\
...
wasi:filesystem/types@0.2.6\x05\x10\x02\x03\0\x0a\x0adescriptor\x01B\x07\x02\x03\
...
\x12\x01B\x04\x01ps\x01ks\x01@\x02\x04names\x04args\0\0\x01\x04\0\x04call\x01\x02\
\x03\0\x1fwawk:plugins/external-functions\x05\x13\x01B\x05\x01@\x01\x05inputs\0s\
\x04\0\x06detect\x01\0\x04\0\x05parse\x01\0\x01@\x01\x09tree-jsons\0s\x04\0\x09s\
erialize\x01\x01\x03\0\x1bwawk:plugins/format-handler\x05\x14\x01B\x03\x01j\0\0\x01\
@\0\0\0\x04\0\x03run\x01\x01\x04\0\x12wasi:cli/run@0.2.6\x05\x15\x04\0\x1ewawk:w\
asi-cli/cli-runner@0.1.0\x04\0\x0b\x10\x01\0\x0acli-runner\x03\0\0\0G\x09produce\
